<nav class="navbar fixed-top navbar-expand-lg background-white-opacity g-0">
  <div class="container-fluid align-items-center ">
    ...
    <div class="navbar-collapse mx-auto collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav w-100 d-flex text-center ">
		  <a class="nav-link menu px-3 mx-3" href="<?php echo $domain;?>about">About</a> 
		  <a class="nav-link menu px-3 mx-3 d-none" href="<?php echo $domain;?>payment">Payment</a> 
		  <a class="nav-link menu px-3 mx-3" href="<?php echo $domain;?>services">Services</a>
		  <a class="nav-link menu px-3 mx-3" href="<?php echo $domain;?>contact">Contact Us</a>
		</div>
    </div>
  </div>
</nav>
